import { AIService, AIServiceOptions, AIModelResponse } from './ai/AIService';
...
import { SearchOptions } from './vectorSearch/VectorSearchService';
...
export class AIEmbeddingService {
  ...
  async findSimilarSubjects(query: string, options?: { 
    ...
    try {
      ...
      if (options?.workspaceId) {
        searchOptions.filters = { workspace_id: options.workspaceId };
      }
  ...
  async findSimilarQuizQuestions(query: string, options?: {
    ...
    try {
      ...
      if (options?.quizId) {
        searchOptions.filters = { quiz_id: options.quizId };
      }
